    ...
    <Layout>
      <div className="h-16 flex-shrink-0 bg-surface border-b border-border -mx-8 -mt-7 px-7 flex items-center justify-between box-border">
        <div className="flex items-center gap-3.5">
          <Link to={`/casos/${id}`} className="flex w-8 h-8 rounded-lg items-center justify-center border border-border">
            <BackIcon />
          </Link>
          <div>
        ...
        <div className="flex gap-2.5">
          <Link to={`/casos/${id}`} className="h-[38px] px-4 rounded-input border border-border flex items-center text-[13px] font-semibold text-text-secondary">
            Cancelar
          </Link>
          <button
      ...
      <div className="flex-grow flex justify-center pt-6 overflow-hidden">
        <div className="w-[640px] flex flex-col gap-[18px] overflow-y-auto">
          ...
          <div className="card p-[22px] flex flex-col gap-2.5">
