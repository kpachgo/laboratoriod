      ...
      <div className="h-16 flex-shrink-0 bg-surface border-b border-border flex items-center justify-between px-8 box-border">
        <div className="flex items-center gap-3.5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="font-display text-[15px] font-semibold">Detalle del pedido</div>
          </div>
        </div>
        <UserMenu nombre={user?.nombre} subtitle="Clínica" onLogout={() => { logout(); navigate('/login'); }} align="right" />
      </div>

      <div className="flex-grow box-border p-8 flex flex-col gap-5">
          ...
          <>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2.5">
                {caso.finalizado_at ? (
                  <>
                    <span className="px-3 py-2 rounded-full text-xs font-bold" style={{ background: '#E7F5EC', color: GREEN }}>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-[340px] flex-shrink-0 card p-5 flex flex-col gap-4">
              ...
              <div className="flex-grow min-w-0 flex flex-col gap-3.5">
                ...
                {pedidos.map((p) => (
                  <div key={p.id} className="card p-[18px] flex flex-col gap-2.5">
                    <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex gap-5 text-[12.5px] text-text-faint flex-wrap">
